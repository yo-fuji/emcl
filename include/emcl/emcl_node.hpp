...
#ifndef INTERFACE_EMCL_HPP__
#define INTERFACE_EMCL_HPP__

#include "emcl/ExpResetMcl.hpp"
...
class EMclNode : public nav2_util::LifecycleNode
{
public:
  EMclNode(const rclcpp::NodeOptions& options);
  ~EMclNode();
