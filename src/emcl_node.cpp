  ...
  : LifecycleNode("emcl_node", "", options)
{
  ...
  if (!this->has_parameter("expansion_radius_position")) {
    rcl_interfaces::msg::ParameterDescriptor descriptor;
    descriptor.type = rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE;
    descriptor.description = "maximum change of the position on the xy-plane when the reset replaces a particle [m]";
    descriptor.read_only = true;
  ...
  if (!this->has_parameter("expansion_radius_orientation")) {
    rcl_interfaces::msg::ParameterDescriptor descriptor;
    descriptor.type = rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE;
    descriptor.description = "maximum change of the yaw angle when the reset replaces a particle [rad]";
    descriptor.read_only = true;
